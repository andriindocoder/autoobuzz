    ...
    <nav class="navbar navbar-site navbar-light bg-light navbar-expand-md" role="navigation">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand logo logo-title">
                <span class="logo-icon"><i class="fa fa-car ln-shadow-logo "></i>
                </span>AUTO<span>BUZZ </span> </a>

            <button class="flag-menu country-flag d-block d-sm-none btn btn-secondary hidden" href="#select-country"
                data-toggle="modal"> <span class="flag-icon flag-icon-us"></span> <span class="caret"></span>
            </button>

            <button data-target=".navbar-collapse" data-toggle="collapse" class="navbar-toggler" type="button"> <span
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="nav-item"><a class="nav-link" href="job-signup.html">Privacy Policy</a></li>
                ...
                <ul class="nav navbar-nav ml-auto navbar-right">
                    ...
                    <li class="postadd nav-item"><a class="btn btn-block   btn-border btn-post btn-danger nav-link"
                            href="job-post.html">Search Car Model</a>
                    </li>
