...
<link rel="apple-touch-icon-precomposed" sizes="114x114"
    href="{{ asset('frontend/assets/ico/apple-touch-icon-114-precomposed.png') }}">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
    href="{{ asset('frontend/assets/ico/apple-touch-icon-72-precomposed.png') }}">
...
<title>@yield('title', 'Autoobuzz | Car Specification, Service Repair Manual, and Wiring Diagram')</title>
<!-- Bootstrap core CSS -->
