        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" role="navigation" class="pull-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="sub-category-sub-location.html">Cars</a></li>
                    ...
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        <div class="row ">
                            <div class="col-sm-9 automobile-left-col">
                                ...
                                <div class="ads-image">
                                    <ul class="bxslider">
                                        <li><img src="{{ asset('frontend/images/auto/2012-mercedes-benz-sls-amg.jpg') }}" alt="img"/></li>
                                        <li><img src="{{ asset('frontend/images/auto/2.jpg') }}" alt="img"/></li>
                                        <li><img src="{{ asset('frontend/images/auto/3.jpg') }}" alt="img"/></li>
                                    </ul>
                                    <div id="bx-pager">
                                        <a class="thumb-item-link" data-slide-index="0" href=""><img
                                                src="{{ asset('frontend/images/auto/2012-mercedes-benz-sls-amg.jpg') }}" alt="img"/></a>
                                        <a class="thumb-item-link" data-slide-index="1" href=""><img
                                                src="{{ asset('frontend/images/auto/2.jpg') }}" alt="img"/></a>
                                ...
                                <div class="card-body text-center">
                                    <div class="seller-info">
                                        <div class="company-logo-thumb">
                                            <a><img src="{{ asset('frontend/images/auto/dealer-logo.png') }}" class=" " alt="img"> </a></div>
